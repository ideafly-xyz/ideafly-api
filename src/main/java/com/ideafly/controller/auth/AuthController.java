...
public class AuthController {
    ...
    @Operation(summary = "获取访问令牌", description = "通过refreshToken获取accessToken")
    public R<Map<String, String>> getAccessToken(@RequestHeader("Authorization") String authorizationHeader) {
